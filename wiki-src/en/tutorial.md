---
title: Tutorial – step-by-step through the ValueApp
subtitle: This tutorial walks you through the ValueApp using an example project. The focus is on what to enter in each tab and how to read the results.
...
Use **Speichern** in the app to store your progress.  
...
- Choose your role (Architect / Architect & GP / General planner)
...
repeat the steps in Projekt & Leistung for each discipline. The summary will show them side-by-side.
...
It can be exported or printed and attached to fee offers or internal planning documents.