...
Dieses Kapitel erklärt, **warum sich die ValueApp so verhält, wie sie sich verhält**.  
Der Fokus liegt auf Konzepten und Logik, nicht auf Klick-für-Klick-Anleitungen.

Wenn Sie praktische Schritte suchen, wechseln Sie zu den [Workflows](workflows.html).
...
- **Ergebnisse interpretieren**  
  ...
  → [Ergebnisinterpretation öffnen](output-interpretation.html)

- **Was ValueApp ist – und was nicht**  
  Klärung von Zweck, Grenzen und häufigen Missverständnissen.  
  → [Zweck und Grenzen öffnen](why-valueapp.html)

---

## Wie dieses Kapitel zu nutzen ist

Nutzen Sie die Wissensbasis, wenn Sie verstehen möchten:

- warum eine Eingabeänderung das Resultat beeinflusst,
- warum die App Spannweiten statt fixer Werte zeigt,
- wie unterschiedliche Projektkonfigurationen zu unterschiedlichen Aufwandsprofilen führen,
- wo fachliches Urteil weiterhin erforderlich ist.

Für konkrete Abläufe und Anwendungsbeispiele wechseln Sie zu:
