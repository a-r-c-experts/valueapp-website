---
i18nTitle: wiki.gettingStarted.title
navKey: getting-started
---

# Einstieg in die ValueApp

Die ValueApp führt Sie in vier Schritten durch den Prozess: Projektbeschrieb, Projektdefinition, Leistungen und Zusammenfassung.  
Diese Seite gibt einen schnellen Überblick, bevor Sie ins ausführliche Tutorial einsteigen.
...
Für vertiefte Erklärungen zu Begriffen und Feldern empfehlen sich die Definitionen.  
Wenn Sie lieber anhand konkreter Beispiele lernen, starten Sie mit den Projektbeispielen.

- → [Definitionen – zentrale Begriffe und Felder](definitions.html)  
- → [Beispiele – einfache und komplexe Projekte](examples.html)  
- → [Tutorial – detaillierte Schritt-für-Schritt-Anleitung](tutorial.html)